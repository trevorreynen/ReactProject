...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Define the full list of ingredients
    const ingredients = [
      'Aether',
      'Albedo',
      "Alchemists' Powder",
    ...
    // Convert ingredients array into objects for bulkInsert
    ...
    // Bulk insert into the Ingredients table
    return queryInterface.bulkInsert('Ingredients', ingredientObjects)
  },
